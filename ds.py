...
# Load a multilingual dataset (here, the Tatoeba dataset)
df = pd.read_csv('https://object.pouta.csc.fi/Tatoeba-Challenge-2017/eng_rus_fra_deu_ita_spa_por_ell.csv')
